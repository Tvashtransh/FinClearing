...
// Mock data for APIs
const ALL_APIS = [
  { id: "code-execution", name: "Code Execution Engine", category: "Validation", desc: "Secure, isolated sandboxed runtime environment to compile and execute user code snippets across 15+ programming languages.", time: "320ms", success: "99.95%", calls: "10M+", price: "₹1.20" },
  ...
  { id: "devdoc-exporter", name: "DevDoc Exporter", category: "Validation", desc: "High-fidelity document generation endpoint rendering programmatic structural text layouts and code blocks into production-ready PDFs.", time: "210ms", success: "99.9%", calls: "20M+", price: "₹0.90" },
  { id: "payload-guard", name: "Payload Guard", category: "Validation", desc: "High-speed data structure checking engine validating heavily nested JSON structures against pre-defined strict developer schemas.", time: "15ms", success: "99.99%", calls: "250M+", price: "₹0.15" },
  { id: "edge-location", name: "Edge Location API", category: "Validation", desc: "Fetch highly accurate network processing and geographic metadata context derived strictly from public edge network incoming IP addresses.", time: "45ms", success: "99.99%", calls: "300M+", price: "₹0.30" },
...
const CATEGORIES = ["All", "Validation", "AI"];
