        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="prose prose-invert prose-zinc max-w-none">
            ...
            <p className="mb-6 text-sm text-zinc-400 leading-relaxed">
              <strong>apiexplore.shop</strong> is committed to providing exceptional support for your developer integration and API execution needs. If you require assistance with your account, API access, or subscription billing, our priority support team is here to help.
            </p>
            ...
            <p className="mb-6 text-sm text-zinc-400">
              We value your time. All support queries regarding API endpoints, execution limits, or billing mandates will be addressed and resolved within <strong>24 to 48 business hours</strong>.
            </p>
          </div>
