...
const plansData = {
  ...
  "endpoints-enterprise": { name: "Enterprise Execution Plan", type: "API Plan", basePrice: 0, isCustom: true, isEndpoints: true, features: ["Isolated Validation Endpoints", "Advanced Rate-Limiting Rules", "Strict 99.99% SLA"] }
};
...
export default function CheckoutCartPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [period, setPeriod] = useState(plan?.isEndpoints ? '1y' : '1mo');
