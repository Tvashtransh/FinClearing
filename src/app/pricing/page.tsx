        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-zinc-950/80 border border-zinc-800 rounded-2xl p-8">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> 1,000 API calls / mo</li>
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Community Support</li>
            </ul>
          ...
          <div className="bg-zinc-950/80 border border-blue-500/50 shadow-[0_0_30px_-5px_rgba(59,130,246,0.3)] rounded-2xl p-8 relative">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Unlimited API calls</li>
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Volume discounts</li>
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Standard Support</li>
            </ul>
          ...
          <div className="bg-zinc-950/80 border border-zinc-800 rounded-2xl p-8">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Dedicated Nodes</li>
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> SLA & SOC2</li>
              <li className="flex items-center gap-3 text-zinc-400 text-sm"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Premium Support</li>
            </ul>
